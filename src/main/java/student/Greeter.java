...
public class Greeter {
     ...
     *
     * System.out.println(greeter.greet(false)); // Kailani, 菴?螂ｽ! ***DELETED CHARACTERS BECAUSE CHARACTER ISSUES. FIX ME***
        ...
        switch (locality) {
            ...
            case CHINA:
                if (asciiOnly) {
                    ...
                    greeting = String.format("%s, 菴?螂ｽ!", name); /* ***DELETED CHARACTERS BECAUSE CHARACTER ISSUES. FIX ME*** */
                    // note "菴?螂ｽ!" while is allowed in java sa unicode, ***DELETED CHARACTERS BECAUSE CHARACTER ISSUES. FIX ME***
